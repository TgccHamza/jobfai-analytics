...
type CompetenceMetricParameter struct {
	...
	// Relationships
	Metric CompetenceMetric `gorm:"foreignKey:MetricID" json:"metric,omitempty"`
}

func (CompetenceMetricParameter) TableName() string {
